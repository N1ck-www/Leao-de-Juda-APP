...
function debtCardEl(d) {
  ...
  el.innerHTML = `
    ...
    ${canCharge ? `<button class="whatsapp-btn" data-action="charge" title="Cobrar via WhatsApp"><svg viewBox="0 0 24 24" width="16" height="16" fill="white"><path d="M6.62 10.79a15.053 15.053 0 006.59 6.59l2.2-2.2a1 1 0 011.01-.24c1.12.37 2.33.57 3.58.57a1 1 0 011 1V20a1 1 0 01-1 1C10.61 21 3 13.39 3 4a1 1 0 011-1h3.5a1 1 0 011 1c0 1.25.2 2.46.57 3.58a1 1 0 01-.25 1.01l-2.2 2.2z"/></svg></button>` : ""}
  `;
  if (canCharge) {
